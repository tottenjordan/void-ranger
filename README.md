...
<img src="docs/images/time_dilation_v2.gif" width="100%" alt="Void Ranger Deep-Space dashboard: deploying a server in a cosmic void and watching the time-dilation metrics update live" />

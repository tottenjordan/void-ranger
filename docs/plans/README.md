...
| [004](004-single-service-cloudrun.md) | Single Cloud Run service (Option C) — serve SPA + API from one origin | 📐 **Planned / in progress** (branch `feat/single-service-cloudrun`) |
| [005](005-educational-visuals.md) | Educational visual aids — PaperBanana diagrams + real-physics plots, embedded across README + deep-dive docs | ✅ **Implemented** — 12 figures in `docs/images/`, embedded; docs-only |
